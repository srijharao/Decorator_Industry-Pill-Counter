...
/**
 * This class represents the system that is using the pill counter. What this class does is
 * illustrated in a test only so that you can run this. In reality, this usage is embedded deep into
 * a larger system, interfacing with actual conveyer belts that are bottling pills.
 */
