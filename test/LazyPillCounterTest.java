...
/**
 * Test Class for Lazy pill counter class.
 */
public class LazyPillCounterTest {
  ...
  @Test
  public void usage() {
    PillCounter lazyPillCounter = new LazyPillCounter(new LoggingPillCounter());
    boolean result = conveyerBelt(lazyPillCounter);
    assertTrue(result);
  }
